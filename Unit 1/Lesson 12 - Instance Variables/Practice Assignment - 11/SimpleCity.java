...
public class SimpleCity extends Object {
   ...
   /*
    * The list of things in the city is really a list of all the things that need
    * to be painted.
    */
    ...
    *              (0=background/intersections, 1=things on intersections,
    *              2=robots)
    */
   public void add(Paintable p, int layer) { // make a new array one longer than the old layer
