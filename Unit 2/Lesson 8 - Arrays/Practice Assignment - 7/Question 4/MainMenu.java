...
public class MainMenu {
    ...
    public static void main(String[] args) {
        ...
        Contact myBook; // The book of contacts
        ...
        myBook = new Contact(numberOfContacts);
    ...
    private static void addContact(Contact myBook) {
        // Variable Declarations
    ...
    private static void removeContact(Contact myBook) {
        // Variable Declarations
    ...
    private static void changeRating(Contact myBook) {
        // Variable Declarations
